...
int flag = 0;
string result;
string tuling_key="0dd3488916f64d4eb3356308c7c20823"; //default tuling key
string userid="HGcastle";
...
{
    ros::init(argc, argv, "castle_tl_nlu_node");    //初始化节点
    ros::NodeHandle n;

    std::string nlu_topic="/voice/castle_tl_nlu_topic";    //定义图灵订阅的话题名称
    std::string tts_topic="/voice/castle_xf_tts_topic";    //定义图灵发布的话题名称，与讯飞tts订阅话题相同

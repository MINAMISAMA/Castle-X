...
const char* fileName = "/home/kyle/catkin_ws/src/castle_voice_system/music/voice.wav" ;
const char* playPath = "play /home/kyle/catkin_ws/src/castle_voice_system/music/voice.wav" ;
...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 5b6d44ed, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
...
int main(int argc, char* argv[])
{
	...
	ros::init(argc, argv, "castle_xf_tts_node");    //初始化节点，节点名为"castle_xf_tts_node"
	ros::NodeHandle n;
	ros::Subscriber sub = n.subscribe("/voice/castle_xf_tts_topic", 3, xfCallBack);    //实例化订阅者，订阅话题为"/voice/castle_xf_tts_topic"
	ros::spin();
	return 0;
}
